...
function Home() {
  ...
  useEffect(() => {
    ...
    const fetchAppointmentCount = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8085/getAppointmentCount",
          { withCredentials: true }
        );
    ...
    const fetchSubmittedCount = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8085/getSubmittedAppointmentCount",
          { withCredentials: true }
        );
    ...
    const fetchAssignedAppintmentCount = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8085/getAssignedAppointmentCount",
          { withCredentials: true }
        );
    ...
    const fetchUnAssignedAppintmentCount = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8085/getUnassignedAppointmentCount",
          { withCredentials: true }
        );
    ...
    const fetchUnCompletedAppintmentCount = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8085/getcompletedAppointmentCount",
          { withCredentials: true }
        );
    ...
    const fetchRejectedAppintmentCount = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8085/getrejectedcount",
          { withCredentials: true }
        );
    ...
    const fetchNullAppintmentCount = async () => {
      try {
        const response = await axios.get(
    ...
    const fetchTodayAppintmentCount = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8085/gettodayappointmentcount",
          { withCredentials: true }
        );
        ...
        <div className="page-wrapper">
          <div className="content">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <Link to="/DataMissingAppointment">
                  <div className="dash-widget">
                    <div
                      style={{
                        display: "flex",
