...
const EditSubAdminMaster = () => {
    ...
    const fetchDetails = async () => {
      try {
        const response = await fetch(
          `http://localhost:8085/getSubadminById/${id}`
        );
  ...
  const handleSave = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8085/updateSubadmin/${id}`,
        {
          method: "PUT",
          headers: {
  ...
  return (
    <div className="main-wrapper" style={{border:'2px solid', borderRadius:'10px', paddingLeft:'50px',paddingRight:'50px',backgroundColor: "#fff"}}>
        ...
        >
          <div style={{ display: "flex", gap: "20px", width: "100%" }}>
            ...
            <div style={{ flex: "1", minWidth: "200px" }}>
              ...
              />
              {errors.mname && (
                <p style={{ color: "red", fontSize: "12px" }}>{errors.mname}</p>
              )}
            </div>
            ...
            <div style={{ flex: "1", minWidth: "200px" }}>
              ...
              />
              {errors.lname && (
                <p style={{ color: "red", fontSize: "12px" }}>{errors.lname}</p>
              )}
            </div>
          </div>
